...
const DBPASSWORD = process.env.DBPASSWORD; //hiding my password in .env file




//mongoDB code connecting
const { MongoClient } = require('mongodb');
const uri = `mongodb+srv://liadensam:${DBPASSWORD}.@cluster0.9u7xs.mongodb.net/test?retryWrites=true&w=majority`;
